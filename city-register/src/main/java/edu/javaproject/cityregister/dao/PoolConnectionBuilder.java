...
/***
 * That class build database connection by creating DB Connection resource in Tomcat +
 * using {@link javax.naming.InitialContext} class;
 */
public class PoolConnectionBuilder implements ConnectionBuilder {

    private static final Logger logger = LoggerFactory.getLogger(PoolConnectionBuilder.class);

    //Create example of Connection pool.
